...
namespace QLKhachSan
{
    public partial class frmThanhToan : Form
    {
        ...
        public frmQLKhachHang frmKH;
        public frmTrangChu frmMain;
        ...
        string sql;
        string chuoiketnoi = @"Data Source=VIETANH;Initial Catalog=QLKhachSan;Integrated Security=True";
        ...
        {
            this.tblkhachhangTableAdapter.Fill(this.QuanLyKSDataSet.tblkhachhang);
